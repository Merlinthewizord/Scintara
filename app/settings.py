...
class Settings(BaseModel):
    ...
    mem0_user_id: str = os.getenv("MEM0_USER_ID", "capernyx")
    mem0_llm_provider: str = os.getenv("MEM0_LLM_PROVIDER", "anthropic")
    mem0_llm_model: str = os.getenv("MEM0_LLM_MODEL", "claude-sonnet-4-20250514")
